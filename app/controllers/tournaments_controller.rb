class TournamentsController < ApplicationController
  ...
  private
    ...
    def tournament_params
      params.require(:tournament).permit(:name, :game_id, :event_id, :description, :num_teams, :team_max_size, :team_min_size, :games_per_round, :teams_per_round, :brackets, :public_teams, :lead_time, :num_parallel_events, :time_between_rounds, :time_rounding, :event_earliest_time, :event_latest_time, :round_length, :start_time, :filter, object_permission_attributes: [:permission_type])
    end
end
